...
//							if (canMove(orgSurface, dstSurface, orgSurfaceID, dstSurfaceID) || ){
//								
//							} else {
//								System.out.println("... pero no se puede mover. ");
//								continue;
//							}
							String surfName = "";
